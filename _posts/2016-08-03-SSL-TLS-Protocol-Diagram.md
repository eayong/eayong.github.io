...
layout: post
title: 图解SSL/TLS协议
description: 图解SSL/TLS协议
date: 2016-08-03 16:58:33 +08:00
tags: "ssl tls security"
---

[CloudFlare](https://www.cloudflare.com/)宣布，开始提供Keyless服务，即你把网站放到它们的CDN上，不用提供自己的私钥，也能使用SSL加密链接。
...
![image](/img/2016-08-03-SSL-TLS-Protocol-Diagram_images/image1.png)
...
第三步，爱丽丝确认数字证书有效，然后生成一个新的随机数（Premaster secret），并使用数字证书中的公钥，
加密这个随机数，发给鲍勃。
...
![image](/img/2016-08-03-SSL-TLS-Protocol-Diagram_images/image2.png)
...
![image](/img/2016-08-03-SSL-TLS-Protocol-Diagram_images/image3.png)
...
![image](/img/2016-08-03-SSL-TLS-Protocol-Diagram_images/image4.png)
...
![image](/img/2016-08-03-SSL-TLS-Protocol-Diagram_images/image5.png)

上图中，客户端给出session ID，服务器确认该编号存在，双方就不再进行握手阶段剩余的步骤，而直接用已有的对话密钥进行加密通信。

session ID是目前所有浏览器都支持的方法，但是它的缺点在于session ID往往只保留在一台服务器上。所以，如果客户端的请求发到另一台服务器，就无法恢复对话。session ticket就是为了解决这个问题而诞生的，目前只有Firefox和Chrome浏览器支持。

![image](/img/2016-08-03-SSL-TLS-Protocol-Diagram_images/image6.png)
